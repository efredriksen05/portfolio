...
function Home() {
  return (
    ...
    <div className="home text-center relative pt-[5rem] md:pt-[10rem]">
      <img src="src/assets/homepage/sparkles_left.png" alt="sparkles" 
      ...
      <h1 className="text-[7rem] md:text-[11rem] gap-0 md: ml-3 mr-3 font-extrabold flex justify-center font-montserrat tracking-wide ">
        ...
        <span className="relative inline-block w-[7rem] md:w-[12rem] align-middle">
          <img
            src="src/assets/homepage/sun.png"
            alt="sun"
      ...
      <img src="src/assets/homepage/sparkles_right.png" alt="sparkles" className="relative left-[10rem] top-[-10rem] md:left-[25%] md:top-[-10rem] w-[60px] md:w-[100px]" />
